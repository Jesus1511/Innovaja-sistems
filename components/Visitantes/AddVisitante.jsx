...
const AddVisitante = ({edificio}) => {
  ...
  return (
    <View style={{backgroundColor:Colors.background, padding:20, flex:1}}>
        ...
        <Text style={{color:Colors.text, fontSize:30, fontWeight:"bold", marginBottom:35}}>Información del Visitante</Text>
        ...
        <View style={styles.form}>
         ...
         <View style={styles.form}>
             <Text style={styles.formText}>Cedula</Text>
             <TextInput
               value={cedula}
               placeholderTextColor={Colors.placeholder}
        ...
        <View style={{justifyContent:"center", flexDirection:"row", marginTop:70}}>
            <TouchableOpacity style={styles.touchable} onPress={() => createVisitante()}>
                <Text style={{fontSize:17, fontWeight:"bold", color:Colors.text}}>Añadir Visitante</Text>
            </TouchableOpacity>
        </View>
    </View>
  )
